/*
 * mega_topology_full.cpp - Single-file mega complex topology serialization with main
 */
...
struct PortConfig
{
    ...
    static constexpr auto fields =
        std::make_tuple(meta::Field<&PortConfig::port>{"port", "Port number"},
                        meta::Field<&PortConfig::protocol>{"protocol", "TCP/UDP"},
...
struct Server
{
    ...
    static constexpr auto fields =
        std::make_tuple(meta::Field<&Server::hostname>{"hostname", "Server name"},
                        meta::Field<&Server::ports>{"ports", "Port configs"},
...
struct DataCenter
{
    ...
    static constexpr auto fields =
        std::make_tuple(meta::Field<&DataCenter::name>{"name", "DataCenter name"},
                        meta::Field<&DataCenter::servers>{"servers", "Servers"},
                        meta::Field<&DataCenter::networkRanges>{"networkRanges", "IP ranges"});
};
...
struct MegaTopology
{
    ...
    static constexpr auto fields = std::make_tuple(
        meta::Field<&MegaTopology::datacenters>{"datacenters", "All DCs"},
        meta::Field<&MegaTopology::serviceEndpoints>{"serviceEndpoints", "Services"},
        meta::Field<&MegaTopology::description>{"description", "Description"});
};
...
int main()
{
    ...
    std::cout << "YAML serialization took: "
              << std::chrono::duration<double, std::milli>(endY - startY).count() << " ms\n";
